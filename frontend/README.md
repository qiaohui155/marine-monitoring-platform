...
- Automatic default basemap by zoom: Satellite Hybrid at zoom 5 or below and Standard Map above zoom 5, with manual selection available for the current page
