...
- Stable map selection: small pointer movement during a click cancels pan inertia and restores the camera, while intentional dragging still works; double-click zoom is disabled
