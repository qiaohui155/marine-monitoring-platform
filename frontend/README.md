...
- Locked manual panning: left-button clicks and drags cannot shift the basemap; feature selection and zoom remain available, while search, home, and track actions can still position the map
