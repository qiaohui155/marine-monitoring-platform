...
The route-based simulated AIS runtime uses migrations 003, 004 and 005 in order.
They create per-vessel motion state, install reviewed offshore routes, preserve a
